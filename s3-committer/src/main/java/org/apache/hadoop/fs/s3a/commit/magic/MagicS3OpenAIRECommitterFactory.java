 ...
 */
public class MagicS3OpenAIRECommitterFactory
  ...
  public static final String CLASSNAME
      = "org.apache.hadoop.fs.s3a.commit.magic.MagicS3OpenAIRECommitterFactory";

  public PathOutputCommitter createTaskCommitter(S3AFileSystem fileSystem,
      Path outputPath,
      TaskAttemptContext context) throws IOException {
    return new MagicS3OpenAIRECommitter(outputPath, context);
  }
