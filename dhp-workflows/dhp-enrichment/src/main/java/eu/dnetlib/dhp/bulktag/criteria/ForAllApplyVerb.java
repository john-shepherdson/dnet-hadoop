...
@VerbClass("forall_apply")
public class ForAllApplyVerb implements Selection, JsonPathAware, ApplyOtherVerbAware, Serializable {
	private String jsonPath;
	private Object params ;
	private String applyVerb;

	public ForAllApplyVerb() {
	}

	public ForAllApplyVerb(final Object param) {
		this.params = param;
	}
