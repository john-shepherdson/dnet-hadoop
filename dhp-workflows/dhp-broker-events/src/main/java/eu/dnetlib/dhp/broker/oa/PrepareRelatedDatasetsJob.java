...
public class PrepareRelatedDatasetsJob {
	...
	public static void main(final String[] args) throws Exception {
		final ArgumentApplicationParser parser = new ArgumentApplicationParser(
				IOUtils
						.toString(PrepareRelatedDatasetsJob.class
		...
		runWithSparkSession(conf, isSparkSessionManaged, spark -> {
			...
			final Dataset<OaBrokerRelatedDataset> datasets = ClusterUtils
					...
					.map((MapFunction<eu.dnetlib.dhp.schema.oaf.Dataset, OaBrokerRelatedDataset>) ConversionUtils::oafDatasetToBrokerDataset, Encoders
							.bean(OaBrokerRelatedDataset.class));
