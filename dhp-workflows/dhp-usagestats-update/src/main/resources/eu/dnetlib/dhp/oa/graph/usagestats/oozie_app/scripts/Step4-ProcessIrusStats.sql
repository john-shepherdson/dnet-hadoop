...
FROM ${usagestats_raw_db}.sushilog s, ${usagestats_db}.datasource_oids d, ${usagestats_db}.result_oids ro
WHERE s.repository=d.oid AND s.rid=ro.oid AND metric_type='ft_total' AND s.source='IRUS-UK'; /*EOS*/