...
public class GenerateRAiDActionSetJobTest {
	...
	private static String graph_base_path;
	...
	void testProcessRAiDEntities() {
		GenerateRAiDActionSetJob
			.processRAiDEntities(spark, input_path, output_path + "/test_raid_action_set", graph_base_path);
	...
	@Test
	void testPrepareGraphRAiD() {

		List<Oaf> entities = GenerateRAiDActionSetJob
				.prepareGraphEntities(
						new RAiDEntity(
								"-92190526",
								Arrays
										.asList(
		...
		OtherResearchProduct orp = (OtherResearchProduct) entities.get(0);
		Relation rel = (Relation) entities.get(1);
