...
public class TransformationJobTest {
  ...
  @Mock private LongAccumulator accumulator;
  ...
  public void transformTest(@TempDir Path testDir) throws Exception {
    final String mdstore_input =
        this.getClass().getResource("/eu/dnetlib/dhp/transform/mdstorenative").getFile();
  ...
  public void testTransformFunction() throws Exception {
    ...
    TransformFunction tf =
        new TransformFunction(accumulator, accumulator, accumulator, xslt, 1, vocabularies);
