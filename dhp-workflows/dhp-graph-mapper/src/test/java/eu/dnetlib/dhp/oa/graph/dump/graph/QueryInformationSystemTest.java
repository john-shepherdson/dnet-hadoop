...
"epos@@European Plate Observing System@@EPOS, the European Plate Observing System, is a long-term plan to facilitate integrated use of data, data products, and facilities from distributed research infrastructures for solid Earth science in Europe.@@@@@@ri",
    ...
    List <String> communityContext = Arrays.asList("<context id=\"clarin\" label=\"CLARIN\" type=\"ri\">\n" +
        ...
        cInfoList.forEach(contextInfo -> {
            switch (contextInfo.getId()){
                case "elixir-gr":
                    ...
                    Assertions.assertEquals("10|rest________::b8e502674c3c3499d5374e9b2ea6d8d5",
                ...
                case "ni":
                    ...
                    Assertions.assertTrue(contextInfo.getDatasourceList().contains(("10|rest________::fb1a3d4523c95e63496e3bc7ba36244b")));
                    break;
                case "dh-ch":
        ...
        cInfoList.forEach(context ->{
            switch (context.getId()){
                case "clarin"://clarin@@Common Language Resources and Technology Infrastructure@@CLARIN@@@@oac_clarin",
                    Assertions.assertEquals("Common Language Resources and Technology Infrastructure", context.getName());
                    Assertions.assertEquals("CLARIN", context.getDescription());
                    Assertions.assertTrue( Optional.ofNullable(context.getSubject()).map(value -> false)
                            .orElse(true));
                ...
                case "ee":
                    ...
                    Assertions.assertFalse( Optional.ofNullable(context.getSubject()).map(value -> false)
                            .orElse(true));
                ...
                case "fam":
                    ...
                    Assertions.assertTrue( context.getDescription().length() > 0);
                    Assertions.assertTrue(context.getDescription().startsWith("Conservation of marine resources for sustainable development"));
                    Assertions.assertFalse( Optional.ofNullable(context.getSubject()).map(value -> false)
                            .orElse(true));
                ...
                case "ni":
                    ...
                    Assertions.assertTrue( context.getDescription().length() > 0);
                    Assertions.assertTrue(context.getDescription()
                ...
                case "mes":
                    ...
                    Assertions.assertTrue( context.getDescription().length() > 0);
                    Assertions.assertTrue(context.getDescription()
                            .startsWith("This community was initially defined to include a very broad range of topics"));
                    Assertions.assertFalse( Optional.ofNullable(context.getSubject()).map(value -> false)
                            .orElse(true));
                ...
                case "instruct":
                    ...
                    Assertions.assertTrue( context.getDescription().length() > 0);
                    Assertions.assertTrue(context.getDescription()
                            .equals("Instruct-ERIC is the European Research Infrastructure for Structural Biology"));
                    Assertions.assertTrue( Optional.ofNullable(context.getSubject()).map(value -> false)
                            .orElse(true));
                    ...
                    break;
                case "elixir-gr":
                    Assertions.assertEquals("The Greek National Node of the ESFRI European RI ELIXIR", context.getName());
                    Assertions.assertTrue( context.getDescription().length() > 0);
                    Assertions.assertTrue(context.getDescription()
                            .startsWith("ELIXIR-GR enhances the potential of the Greek bioinformatics community to offer open"));
                    Assertions.assertTrue( Optional.ofNullable(context.getSubject()).map(value -> false)
                            .orElse(true));
                ...
                case "aginfra":
                    ...
                    Assertions.assertTrue( context.getDescription().length() > 0);
                    Assertions.assertTrue(context.getDescription()
                            .startsWith("The scope of this community is to provide access to publications, research data, projects and software"));
                    Assertions.assertFalse( Optional.ofNullable(context.getSubject()).map(value -> false)
                            .orElse(true));
                    Assertions.assertEquals(18, context.getSubject().size());
                ...
                case "dariah":
                    ...
                    Assertions.assertTrue( context.getDescription().length() > 0);
                    Assertions.assertTrue(context.getDescription()
                            .startsWith("The Digital Research Infrastructure for the Arts and Humanities (DARIAH) aims to enhance and support "));
                    Assertions.assertTrue( Optional.ofNullable(context.getSubject()).map(value -> false)
                            .orElse(true));
                ...
                case "epos":
                    ...
                    Assertions.assertTrue( context.getDescription().length() > 0);
                    Assertions.assertTrue(context.getDescription()
                            .startsWith("EPOS, the European Plate Observing System, is a long-term plan to facilitate integrated use of "));
                    Assertions.assertTrue( Optional.ofNullable(context.getSubject()).map(value -> false)
                            .orElse(true));
                ...
                case "covid-19":
                    ...
                    Assertions.assertTrue( context.getDescription().length() > 0);
                    Assertions.assertTrue(context.getDescription()
                            .startsWith("This portal provides access to publications, research data, projects and "));
                    Assertions.assertFalse( Optional.ofNullable(context.getSubject()).map(value -> false)
                            .orElse(true));
