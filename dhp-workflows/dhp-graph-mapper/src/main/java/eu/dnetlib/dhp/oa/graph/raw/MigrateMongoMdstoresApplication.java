...
public class MigrateMongoMdstoresApplication extends AbstractMigrationApplication
    ...
    public static void main(final String[] args) throws Exception {
        ...
        try (MigrateMongoMdstoresApplication app =
                new MigrateMongoMdstoresApplication(hdfsPath, mongoBaseUrl, mongoDb)) {
    ...
    public void execute(final String format, final String layout, final String interpretation) {
        final Map<String, String> colls =
                mdstoreClient.validCollections(format, layout, interpretation);
