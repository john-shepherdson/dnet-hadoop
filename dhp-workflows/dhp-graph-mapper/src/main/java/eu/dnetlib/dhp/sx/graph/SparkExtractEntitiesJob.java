...
/**
 * This Job extracts a typology of entity and stores it in a new RDD This job is called different
 * times, for each file generated by the Job {@link ImportDataFromMongo} and store the new RDD in a
 * path that should be under a folder: extractedEntities/entity/version1
 *
 * <p>at the end of this process we will have : extractedEntities/dataset/version1
 * extractedEntities/dataset/version2 extractedEntities/dataset/...
 * extractedEntities/publication/version1 extractedEntities/publication/version2
 * extractedEntities/publication/... extractedEntities/unknown/version1
 * extractedEntities/unknown/version2 extractedEntities/unknown/...
 * extractedEntities/relation/version1 extractedEntities/relation/version2
...
public class SparkExtractEntitiesJob {
    ...
    public static void main(String[] args) throws Exception {
        ...
        List<String> entities =
                Arrays.stream(parser.get("entities").split(","))
                        .map(String::trim)
