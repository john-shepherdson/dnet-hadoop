...
/**
 * In some case the identifier generated for the Entity in @{@link SparkExtractEntitiesJob} is
 * different from the identifier * associated by the aggregator, this means that some relation
 * points to missing identifier To avoid this problem we store in the model the Id and the
 * OriginalObJIdentifier This jobs extract this pair and creates a Similar relation that will be
 * used in SparkMergeEntities
 */
