...
select /*+ COALESCE(100) */ substr(rel.source, 4) as source, substr(rel.target, 4) as target, relclass, subreltype, r1.resulttype.classname as sourcet_type, r2.resulttype.classname as target_type
