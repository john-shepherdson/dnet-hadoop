      ...
      override def reduce(b: Publication, a: (String, Publication)): Publication = {
        ...
        if (b == null) {
          ...
          if (a != null && a._2 != null) {
            b.mergeFrom(a._2)
            b.setId(a._1)
<<<<<<< HEAD:dhp-workflows/dhp-doiboost/src/main/java/eu/dnetlib/doiboost/SparkGenerateDoiBoost.scala
...
=======
            ...
            b.setAuthor(authors)
>>>>>>> beta:dhp-workflows/dhp-doiboost/src/main/scala/eu/dnetlib/doiboost/SparkGenerateDoiBoost.scala
            return b
          }
        }
        new Publication
