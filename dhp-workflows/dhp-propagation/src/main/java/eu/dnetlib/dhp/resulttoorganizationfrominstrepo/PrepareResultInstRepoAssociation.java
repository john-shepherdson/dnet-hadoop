...
public class PrepareResultInstRepoAssociation {
    ...
    private static void prepareAlreadyLinkedAssociation(
        ...
        String query =
                "Select source resultId, collect_set(target) organizationSet "
                        + "from relation "
    ...
    private static void readNeededResources(SparkSession spark, String inputPath) {
        ...
        org.apache.spark.sql.Dataset<Datasource> datasource =
                spark.createDataset(
        ...
        org.apache.spark.sql.Dataset<Organization> organization =
                spark.createDataset(
    ...
    private static void prepareDatasourceOrganizationAssociations(
        ...
        String query =
                "SELECT source datasourceId, target organizationId "
                        + "FROM ( SELECT id "
                        + "FROM datasource "
