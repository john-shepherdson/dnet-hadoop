pipeline {
    ...
    parameters {
        string(name: 'BASE_VERSION', defaultValue: '1.2.6-SNAPSHOT', description: 'Base version (e.g., 2.1.0 or 2.1.0-SNAPSHOT)')
        ...
        stage('Build with Maven Profile') {
            ...
            steps {
                withMaven {
                    ...
                    sh "mvn clean package -P${params.MAVEN_PROFILE} -DskipTests"
                }
            }
        }
